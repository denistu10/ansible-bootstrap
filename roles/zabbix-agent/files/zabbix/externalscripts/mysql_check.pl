#!/usr/bin/perl
#
# https://share.zabbix.com/databases/mysql/template-mysql-800-items
#
# Instructions:
...
# GRANT SELECT, PROCESS, REPLICATION CLIENT, SHOW DATABASES ON *.* TO 'zabbix_mysql'@'localhost' IDENTIFIED BY 'Geitu2suuhieSei';
# FLUSH PRIVILEGES;
